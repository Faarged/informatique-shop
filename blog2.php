    ...
    <section class="section-1">
        <div class="jumbotron d-flex align-items-center">
            ...
            <div class="container-fluid content">
                <h1 data-aos="fade-right" data-aos-delay="300">Bienvenue sur la page produits</h1>
                <h2 data-aos="fade-left" data-aos-delay="300">Nous avons une multitude d'articles à vous soumettre</h2>
            </div>
            <!--container-fluid end-->
        </div>
    </section>
            ...
            <div class="row bt">
                <div class="col-sm-12">
                    <ul>
                        ...
                        <li><a class="active" href="blog2.php">2</a></li>
                        <li><a href="#">3</a></li>
                        <li><a href="#">4</a></li>
                        <li><a href="#">5</a></li>
                    </ul>
